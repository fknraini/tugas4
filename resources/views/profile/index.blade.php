          ...
          <div class="row">
           <div class="col-md-12">
            ...
            @forelse($forums as $forum)
               <tr> 
                <td>{{$forum->title}} <i style="font-size: 10px; color: #999;"> {{$forum->created_at->diffForHumans()}}, {{$forum->comments->count()}} Comments, 0 Views</i>
                 </td>
                ...
                <td width="10"> 
                <form action="{{route('forum.destroy', $forum->slug)}}" method="post" style="margin: 0;">
                 {{csrf_field()}}
                  {{method_field('DELETE')}}
